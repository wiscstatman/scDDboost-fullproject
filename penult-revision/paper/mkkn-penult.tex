...
\textcolor{black}{Details confirming such equality are examplified further in Supplementary Material Section 2.1.} The fact is so central that we emphasize:
...
\textcolor{black}{in a controlled setting}.
 \textcolor{black}{Splatter is a generative system for simulating realistic
...
drawn by various other methods (Supplementary Material, Table S3), and where there are differences the 
\texttt{scDDboost} call is plausible (Supplementary Material, Figure S12).   Among 
...
permutatation study (Supplementary Material, Figure S15).  There can be substantial differences in yeild at
a given FDR control level (Supplementary Material, Table S5).}
