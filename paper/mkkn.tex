...
Notice that $f_{g,k}$ does not depend on the condition label $y$, 
as the subtype identification is for cells pooled from two conditions and subtypes are not condition specific.
