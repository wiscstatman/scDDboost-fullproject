...
of three genes identified by scDDboost at 5\% FDR, but not similarly identified by MAST, scDD, and DESeq2.
 ...
 Heatmap (right) shows these three genes among 137 other cell-cycle genes (GO:0007049), with expression from low (blue) to high 
...
We propose $K-$medoids clustering on the full set
...
Future numerical experiments would also assess the operating characteristic when we have large number of cells with low reads each cell.(e.g. UMI data)
