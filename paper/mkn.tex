...
introduce a novel empirical Bayesian mixture approach and evaluate its operating characteristics 
...
numerical experiments, is improved sensitivity compared to several standard approaches
 for detecting subtle distributional expression changes. **computationally efficient?**
\end{abstract}
