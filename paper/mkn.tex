...
Three biologically meaningful parameters (rate of promoter activation, rate of promoter inactivation and the rate of transcription) characterize the model, which made
