...
BIRC5 is differentially expressed in the cell cycle \citep{BIRC5},HMMR is differentially expressed in the cell cycle \citep{HMMR}, RDX 
(not finalized version, needs to use other way to combine those two figs)
 \label{fig:whet} }
\end{figure}
