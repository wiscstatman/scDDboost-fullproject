...
With the data-generative state $(\phi, \psi) \in A_{\pi^r}$, one might ask how posterior probability mass
tends to be allocated among the different containing support sets.  
