...
By way of example, 
Figure~\ref{fig:whet} shows several genes that are called differentially distributed by \verb+scDDboost+
between two populations of cells in a stem-cell study. These particular genes
were not detected by other standard approaches (see Supplementary Material Section~1 for further details.)  
In addition to finding similar strong signals, the proposed method is often better able to detect weak changes
compared to other methods, at the same level of false-discovery rate.  **any more on these genes?**
