...
Computations become more intensive the larger is the number $K$ of cell subtypes. Further, 
...
and recall the posterior mixing proportions $\omega^{\rm post}_\pi$ from equation~(\ref{eq:postmix}) with hyper-parameters $\alpha_i^j \geq 1 \forall i = 1,..,K, j = 1,2$.   Then
\begin{eqnarray*}
\frac{\omega^{\rm post}_{\pi_1} }{ \omega^{\rm post}_{\pi_2} } \longrightarrow_{a.s.} 0 \qquad 
 {\mbox {\rm as $n \longrightarrow \infty$}}. 
\end{eqnarray*}
\end{theorem}
**do we need something about alpha's exceeding 1?**
...
**XIUYU...IS THIS ANOTHER WAY TO GET OMEGA minus Q? I MIGHT BE WAY OFF!!**
