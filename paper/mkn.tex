...
\noindent
{\bf Property 3:} With $k \in b$, marginal means are:
\begin{eqnarray*}
...
We say $\pi^c$  coarsens $\pi^r$ when $\pi^r$ refines $\pi^c$. Refinements increase the number of blocks.
...
that coarsens $\pi^r$.  Refinements reduce the dimension of allowable parameter states,  and the
