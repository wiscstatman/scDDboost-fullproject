...
\includegraphics[width = 0.5\textwidth]{Figs/clussz.pdf}
 ...
 For the whole genome, we count the size of each cluster given by the DE pattern. We expected those uniquely identified DD genes having large proportion on the more frequent DE patterns shared among genes (corresponding with larger cluster size). data from EMTAB2805}
  \label{fig:7}
\end{figure}
