...
\verb+splatter+ for generating synthetic data [citation] as well as the compendium of scRNA-seq
data available through \verb+conquer+ [citation].  **something on bursting?**
...
This methodology extends \verb+scDD+\cite{ref:scDD},                        
