...
the same subtype, say all $c$ such that $z_c=k$, have **

**{\em modifying further}**
...
applied it to a series of random splits of single-condition data sets (Appendix Table **). Figure~\ref{nullperm}
confirms a very low call rate in cases where no changes in distribution are expected.
**{\em Xiuyu, your notes said other methods used nomial p-value of 0.05; but did you mean adjusted p-value?}**
...
\includegraphics[width = 0.8\textwidth]{Figs/fdrCounts.pdf}
 \caption{False positive counts by several methods on  null **how many** random splits of **how many* single condition
data sets from Appendix Table **} \label{fig:nullperm}
\end{figure}
