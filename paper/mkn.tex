...
\includegraphics[width = 0.6\textwidth]{Figs/clussz.pdf}
 \caption{  histograms of log cluster size of genes with PDD greater than 0.95 under two categories.
 ...
 We grouped genes to the same cluster if they share the same DE pattern between subtypes having the maximum of posterior probability. 
 We use the number of genes within a cluster as the size. 
