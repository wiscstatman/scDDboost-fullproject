...
and G2/M cells at three genes (BIRC5, HMMR, and CKAP2),  which we know from prior studies  have differential activity between G1 and G2/M~\citep{BIRC5,HMMR,RAD21}.  Standard statistical tools do not identify the differences in any of these genes
...
\endminipage
 ...
 \caption{Genes involved in cell-cycle that are uniquely identified by scDDboost
 as differentially distributed between cell-cycle phases G1 and G2/M. 
...
of three genes identified by scDDboost at 5\% FDR, but not similarly identified by other approaches. 
 Prior studies have shown that BIRC5, HMMR, and CKAP2  have expression changes between these cell-cycle phases,
