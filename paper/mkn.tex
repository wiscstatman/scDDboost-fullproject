...
the same subtype, say all $c$ such that $z_c=k$, have uni-modal density for transcripts. Using the Negative Binomial model with Beta prior from EBSeq \citep{ref:Leng} 
...
We further assume marginal of $M_{g,\pi}$ are shared by all genes and we estimate hyper-parameters through first-order EM algorithm. (Details at supplementary material 2.2.1)
