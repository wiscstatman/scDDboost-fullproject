...
Cycle biological process (GO:0007049) while other methods (MAST, scDD and DESeq2) in total identified ### genes (see Supplementary Material Section~1 for further details.)  
...
\includegraphics[width = 0.9\textwidth]{Figs/density_Fucci_dd.pdf}
 ...
 from a study of stem cell differentiation (Leng {\em et al.} 2015). Shown are CDF for log2-scale expression
of  6 marker genes related to G1 or G2/M phase uniquely identified by scDDboost at 5\% FDR.   \label{fig:whet} }
\end{figure}
