...
in a typically large genes by cells data matrix $X$.  Summing up, the data structure entails an expression matrix
$X$, a treatment label vector $y$, and a vector of latent subtype labels $z$.
