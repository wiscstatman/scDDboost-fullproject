...
Transcriptional bursting is a fundamental property of genes. In its simplest form, the gene is proposed to exist in two states, one where activity is negligible and one where there is a certain probability of activation\citep{Raj:2008aa}. Such biological phenomena would create subtle changes of transcripts between conditions. 
