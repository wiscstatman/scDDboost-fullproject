...
a matrix holding {\em true} distances $\delta_{i,j}$ between cell $i$ and cell $j$, and that $f$ is some assignment
function, such as induced by the $K-$medoids algorithm.  Then posterior uncertainty in $z$ would follow 
from  posterior uncertainty in $\Delta$.
