...
Using the proposed compositional model, subtypes inferred by clustering from whole genome data 
improve the analysis of gene-level expression.  The methodology merges two lines of computation
...
problem.  Numerical experiments  on both synthetic and published scRNA-seq data indicate improved
