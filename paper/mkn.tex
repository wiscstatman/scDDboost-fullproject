...
we use the Beta prior from EBSeq \citep{ref:Leng} and 
%\begin{eqnarray*}
...
Marginal density of $M_{g,\pi}$ are assumed to be shared by all genes and we estimate hyper-parameters %$(P(M_{g,\pi}),\alpha,\beta^g)$%
through first-order EM algorithm. (Details at supplementary material 2.2.1)
