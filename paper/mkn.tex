...
and G2/M cells at three genes (BIRC5, HMMR, and CKAP2)  that we know from prior studies  have differential activity between G1 and G2/M.  While standard statistical tools do not identify the differences in any of these genes
to be statistically significant at 5\% FDR control, \verb+scDDboost+ does put these genes on its 5\% FDR list.
...
subtypes have changed in their proportions between G1 and G2/M; for instance, there is a lower proportion
 of {\em red} cells   and a greater proportion of {\em orange} cells in G2/M (right).  We note that \verb+scDDboost+ 
...
\minipage{0.64\textwidth}
 \includegraphics[clip,width=\textwidth]{Figs/HeatUni.pdf}
\endminipage
...
\begin{figure}[H]
\includegraphics[width = 0.7\textwidth]{Figs/fdrCounts.pdf}
