...
tends to be allocated among the different support sets that contain this state.     In particular, we 
consider the posterior mixing frequencies $\omega^{\rm post}_\pi$ from equation ** . We find:

**lemma/proposition/theorem? on ratio of omega-posts **
