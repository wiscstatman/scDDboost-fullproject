...
We want to match the posterior probability that elements $i$ and $j$ belongs to the same cluster through a simple bayesian analysis to random weighting, which is equivalently to match 
\begin{eqnarray*}
