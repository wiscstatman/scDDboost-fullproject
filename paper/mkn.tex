...
and G2/M cells at three genes (BIRC5, HMMR, and CKAP2),  which we know from prior studies  have differential activity between G1 and G2/M.  Standard statistical tools do not identify the differences in any of these genes
...
are inferred from genome-wide data, and they infuse information into gene-specific tests, which measure 
