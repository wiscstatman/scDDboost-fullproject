...
\textsc{scDDboost} is in Algorithm~\ref{alg:scDDboost}, Appendix.
...
We simulate data by \verb+splatter+~\citep{ref:Zappia}, 
a recently developed simulation scheme having good approximation to empirical data and providing interface for simulating cells from multiple groups. To evaluate sensitivity of our methods.  
