...
biology (cite), and cancer (cite)(not sure about which paper to cite).  Computational tools and statistical methodologies 
...
\subsection{future work |:extension to multiple conditions}
...
\end{theorem}
\subsection{future work ||: theoretical support for randomized distance matrix}
