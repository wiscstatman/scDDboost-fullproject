...
By way of example, 
Figure~\ref{fig:whet} shows several genes that are called differentially distributed by \verb+scDDboost+ but not
detected by other standard approaches in an example (see Supplementary Material Section 1.)  
In addition to finding similar strong signals, the proposed method is able to detect more subtle changes
than other methods, at the same level of false-discovery rate.  **any more on these genes?**
