...
in a typically large {\sc{genes}} by {\sc{cells}} data matrix $X$.  In review, the data structure entails an expression matrix
...
\raggedright\hspace*{\algorithmicindent} \textbf{Input}: \begin{list}{}{}
 ...
 \item \textsc{cells} by \textsc{cells} distance matrix $D=(D_{c,c'})$
...
\begin{algorithmic}[1]
\Procedure{scDDBoost-core}{$X,y,D,K$}
\State cell clustering: $\hat z = \hat z(D,K) \gets$ labeled parition of cells into $K$ classes
