...
The prior distribution for a partition $\pi$ is also taken as a product form
\begin{eqnarray*}
p(\pi)\propto \overset{q}{\underset{i = 1}{\prod}}h(S_i)
\end{eqnarray*}
...
\begin{eqnarray*}
X_i | \lambda_i \sim Poisson(\lambda_i)
\end{eqnarray*}
