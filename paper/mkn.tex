...
\end{align*}
One important feature of EBSeq \citep{ref:Leng} is that marginal density of $M_{g,\pi}$ are shared by the whole genome.
Mass of DE patterns on one gene depend on mass of DE patterns on other genes, which increase accuracy of our methods Figure~\ref{fig:EBSeq}.
