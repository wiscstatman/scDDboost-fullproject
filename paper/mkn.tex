...
We simulate datasets under 3 different number of groups : $K$ =  3, 7, 15.  As feasibility of computation, \textsc scDDboost can only handle $K$ up to 9. We assess whether \textsc scDDboost 
