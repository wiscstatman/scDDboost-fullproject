...
Among those 12 datasets. 11 of them each condition having $50 \sim 100$ cells and the other one (GSE84465) having larger number of cells with 1300 cells in condition 1 and 700 cells in condition 2.
...
\includegraphics[width = 0.5\textwidth]{Figs/clussz.pdf}
 ...
 For the whole genome, we count the size of each cluster given by the DE pattern. We expected those uniquely identified DD genes having large proportion on the more frequent DE patterns shared among genes (corresponding with larger cluster size) Except the largest one, typically is associated with all subtypes having equivalent expression. data from EMTAB2805}
  \label{fig:7}
\end{figure}
