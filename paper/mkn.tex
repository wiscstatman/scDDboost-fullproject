...
has produced useful tools for identifying subtypes, including: 
...
\verb+DESEQ2+ \citep{ref:Des}, \verb+SCDD+ \citep{ref:scDD}, etc.  These tools respond
...
\end{align}
$c' = c/\frac{\Gamma(n_1 + 1)\Gamma(n_2+1)\Gamma(2K)}{\Gamma(n_1 + n_2 + 2K)}$ And we have theorem 4.\\
