...
\end{eqnarray*}
which is also an upper tail probability for a unit-mean Gamma deviate with shape and scale equal to $\hat a$.  
Comparing to~(\ref{eq:rw}),  by setting  $\hat a$ to equal $a_0 + a_1$, and making $d_0$ relatively small, 
we find
\begin{eqnarray*}
