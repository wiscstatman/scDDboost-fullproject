...
\begin{figure}[h!]
  ...
  \caption{first two principal components of transcripts, which demonstrates the difference between subtypes.}
  \label{fig:4}
\end{figure}
...
\minipage{0.33\textwidth}
  \includegraphics[height = 6cm,width=\linewidth]{sim56.png}
\endminipage\hfill
\minipage{0.33\textwidth}
  \includegraphics[height = 6cm, width=\linewidth]{sim67.png}
\endminipage\hfill
\minipage{0.33\textwidth}
  \includegraphics[height = 6cm, width=\linewidth]{sim78.png}
  \endminipage
...
\minipage{0.5\textwidth}
  ...
  \endminipage
\caption{2D histogram for comparing estimated parameters of DD genes identified by scDDboost from dataset EMTAB2805: rate of promoter activation, rate of promoter inactivation and rate of transcription when the promoter is in the active state}
\end{figure}
\end{center}
...
\endminipage\hfill
\minipage{0.3\textwidth}
  \includegraphics[height = 5cm, width=\linewidth]{E28_78.png}
  \endminipage
