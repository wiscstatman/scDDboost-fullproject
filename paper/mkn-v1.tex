...
\minipage{0.5\textwidth}
  \includegraphics[height = 8cm, width=\linewidth]{sim67.png}
\endminipage\hfill
\minipage{0.5\textwidth}
  \includegraphics[height = 8cm, width=\linewidth]{sim78.png}
  \endminipage
\caption{comparison of posterior probabilities of being DD among different number of subtypes}
\end{figure}
\begin{figure}[h]
  \includegraphics[height = 6cm, width = 10cm]{roc.png}
  \caption{Roc curve of scDDboost, scDD, MAST and DESeq2, scDDboost has largest area under the roc curve. Roc curves of Mast and DEseq2 are similar. For those roc curve there is bigger difference at low level of false positive rate, as scDDboost identified twice many true DD genes as other methods.}
  \label{fig:5}
\end{figure}
...
\begin{figure}[H]
\includegraphics[height = 8cm, width = 10cm]{FDR1.png}
...
\begin{center}
\begin{figure}[H]
\includegraphics[height = 6cm,width =\linewidth]{act.png}
\end{figure}
\begin{figure}[H]
\includegraphics[height = 6cm,width =\linewidth]{in_act.png}
\end{figure}
\begin{figure}[H]
\includegraphics[height = 6cm,width= \linewidth]{t_rate.png}
\end{figure}
\captionof{figure}{2D histogram for comparing estimated parameters of DD genes identified by scDDboost from dataset EMTAB2805: rate of promoter activation, rate of promoter inactivation and rate of transcription when the promoter is in the active state}
\end{center}
