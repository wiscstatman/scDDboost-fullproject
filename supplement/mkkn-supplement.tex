...
\begin{figure}[h!]
  ...
  From left to right, the associated hyper-parameters are (0.1,0.4), (-0.1,0.3), (0.3,0.5), (-0.1,1) and K = 3}
  \label{fig:pca1}
\end{figure}
...
\caption{similar plots as Supplementary Figure~\ref{fig:pca1}, but for K = 7}
\label{fig:pca2}
\end{figure}

\begin{figure}[h!]
  \includegraphics[ width = 0.8\textwidth]{Figs/pca12.pdf}
  \caption{similar plots as Sumpplementary Figure~\ref{fig:pca1}, but for K = 12}
  \label{fig:pca3}
  \end{figure}
