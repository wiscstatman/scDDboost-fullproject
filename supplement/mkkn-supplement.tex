...
We set the default value of  $\epsilon$ to be 1, as we found this yields good performance on simulations and consistent results with other scRNA-methods (e.g. number of DD genes identified).
