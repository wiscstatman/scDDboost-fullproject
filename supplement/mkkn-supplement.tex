...
Too big $K$ may end up overfitting such that two subtypes can be very similar. Given that we have a fixed number of samples (cells), allowing more clusters will introduce a lot of patterns (both for mean expression change and proportion change) to infer. 
The increase of time and memory cost make the computation infeasible. \\
