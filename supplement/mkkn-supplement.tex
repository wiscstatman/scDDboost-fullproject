...
ROC curves for the simulated data in Supplementary Figure \ref{fig:roc}. Each sub-figure is averaged over two replicates under the same parameters setting. scDDboost tends to outperform other methods .
\begin{figure}[h!]
