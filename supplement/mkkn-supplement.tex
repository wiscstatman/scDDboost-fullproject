...
\caption{PDD under $K = 5$ vs. $K = 6$ for dataset DEC-EC (GSE75748). without the randomization (left) vs. with randomized distance (right). We increase robustness of our methods through random weighting.}
\label{fig:s10}
\end{figure}
