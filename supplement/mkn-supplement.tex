...
We use method of moments to estimate $\sigma_g$. Specifically, if 
...
\begin{align*}
&h_1^{g}(X_g^{1,2,3}) = f(X_g^{1,2,3})\\
&h_2^{g}(X_g^{1,2,3}) = f(X_g^{1,2})f(X_g^3)\\
&h_3^{g}(X_g^{1,2,3}) = f(X_g^1)f(X_g^{2,3})\\
&h_4^{g}(X_g^{1,2,3}) = f(X_g^{1,3})f(X_g^2)\\
&h_5^{g}(X_g^{1,2,3}) = f(X_g^1)f(X_g^2)f(X_g^3)\\
\end{align*}
