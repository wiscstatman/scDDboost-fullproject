...
To proof theorem 4 and 5, we need a crucial lemma which gave us an approximation to the gamma function, as the density of DDM is computed by product or ratio over bunches of gamma function
