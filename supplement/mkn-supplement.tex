...
We fix $d_0$ and obtain $a_0, a_1$ from MLE of marginal density of $d_{i,j}$. We estimate $d_0$ by treating $d_{i,j} \appox \Delta_{i,j}$ and $\frac{\text{E}(1/\Delta_{i,j})}{\text{Var}(1/\Delta_{i,j})} = d_0$ can be approximately estimated by ratio of first and second sample moments of $1 / d_{i,j}$.
