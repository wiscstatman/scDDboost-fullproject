...
Through the sampling procedure of our model (Figure 3). We have $z^1, z^2$ are multinomial draw given $(\phi,\psi)$
fact 1: $y,z$ is the sufficient statistics for the posterior of $(\phi,\psi)$\\
fact 2: 
fact 3:
