...
Potentially to be DD genes uniquely identified by us. 
...
Proof of property 2
\begin{proof}
$E_{\pi}(\phi_k) = E_{\tilde{\phi}_b}(\tilde{\phi}_k)E_{\Phi}(\Phi_b)$ where $b$ is the block containing subtype index $k$. As $\tilde{\phi_b} &\sim & \text{Dirichlet}_{N(b)}[ \alpha_b^1 ]$ and  $\Phi_\pi  &\sim& \text{Dirichet}_{N(\pi)}[   \beta_\pi   ] $
We have $E_{\tilde{\phi}_b}(\tilde{\phi}_k) =  \frac{ \alpha^1_k }{ \sum_{k' \in b} \alpha^1_{k'} } $ and $E_{\Phi}(\Phi_b) = \frac{ \beta_b }{ \sum_{b' \in \pi} \beta_{b'} } $
\end{proof}
\begin{lemma}
