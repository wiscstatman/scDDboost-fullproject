...
it would be sufficient to capture the heterogeneity underlying cells with number of clusters less than 9.  
...
We demonstrate the change of posterior probabilities of differential distribution given different $K$ at data GSE75748. The variance of the differential term $\text{PDD}_{K + 1} - \text{PDD}_K$ keep decreasing from $K = 3 - 6$. Our selected $K = 5$.  
