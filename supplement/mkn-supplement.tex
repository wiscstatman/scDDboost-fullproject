...
Thus $P(X,y,z | \theta) = P(y, z | \phi,\psi ) P(X | z, \mu, \sigma)$, and we separately give priors for $(\mu,\sigma)$ and $(\phi, \psi)$
By the Baye's rule, 
\begin{align*}
...
\end{align*}
From this we know\\
1. Given $X,y$ and $z$, $(\phi, \psi) \perp (\mu_{g,k}, \sigma_g)$\\ 
2. Given condition and subtypes label $y,z$, $(\phi,\psi)$ is independent with $X$\\
3. Given $X$ and $z$, $(\mu_{g,k}, \sigma_g)$ is independent with $y$\\
