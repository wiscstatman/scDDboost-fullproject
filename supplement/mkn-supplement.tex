...
\subsection{Synthetic Data}
 ...
 We first look at the pca plots of the simulated data (need updates)
...
Roc curve for the simulated data, each sub-figure is averaged over two replicates under the same parameters setting.
\begin{figure}[h!]
