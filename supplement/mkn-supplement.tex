...
\end{proof}
We have another lemma and theorem 1 and 2 are just proportion of the lemma
\begin{lemma}
...
By Taylor expansion at $x= 1$, $\text{ln}(x + 1) = \text{ln}2 + 1/2(x - 1) - 1/8(x - 1)^2 + g(\xi) (x - 1)^3$, where $g(\xi)$ is the reminder term of form $1/3(1+\xi)^3$ for $ 0 < \xi < x$
...
$U(\pi) = \Sigma_{b\in\pi}\big[(2c - 1/2) \text{ln}(\beta_b + t_b^1 + t_b^2) 
 ...
 By CLT we know $X_b^1, X_b^2$ are asymptotic gamma($\chi$-square) distributed and $Y_b^1, Y_b^2$ are $o_p(1)$ and $T(\pi_1) - U(\pi_2) = O(1)$ if $N(\pi_1) = N(\pi_2)$, $T(\pi_1) - U(\pi_2) = -\text{ln}(n)$ if $N(\pi_2) < N(\pi_2)$ so we complete the proof
