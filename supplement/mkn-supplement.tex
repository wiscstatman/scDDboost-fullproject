...
\begin{eqnarray*}
d(\pi_1, t^1, t^2, \alpha, \beta) \geq \underset{b\in \pi}\Sigma (\beta_b + t_b^1 + t_b^2 - c) \text{ln}(\beta_b  + t_b^1 + t_b^2) - \overset{2}{\underset{j = 1}{\Sigma}}\underset{b\in\pi}\Sigma (t_b^j + \gamma_b^j - 1/2) \text{ln}(t_b^j + \gamma_b^j)
\end{eqnarray*}

RHS = 
\begin{eqnarray*}
(1 - c) \text{ln}(\beta_b + t_b^1 + t_b^2)  + (t_b^1 + \gamma_b^1) \text{ln}(1 + \frac{t_b^2 + \gamma_b^2}{t_b^1 + \gamma_b^1})\\
...
By Taylor expansion at $x= 1$, $\text{ln}(x + 1) = \text{ln}2 + 1/2(x - 1) - 1/8(x - 1)^2 + g(\xi) (x - 1)^3$, where $g(\xi)$ in the reminder term is $1/3(1+\xi)^3$
