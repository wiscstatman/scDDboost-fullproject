...
17421 genes, 10\% of which exhibited actual shifts in distribution between two conditions \textcolor{red}{
...
our experiments on splatter parameters $(\theta, \gamma)$ (also called ** **) which encode distributional
...
four settings varying the signal differences between subtypes **?what about subytpe frequencies?**}
