...
Let $\mathcal{E}_{0.05}$ be the union genes identified by t-test, DESeq2, MAST and scDD.
Table \ref{tab:cs} demonstrates that most DD genes identified by our method are also confirmed by t test.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{} lcccr @{}} % Column formatting, @{} suppresses leading/trailing space
      ...
      $|\mathcal{D}_{0.05} \cap \mathcal{R}_{0.05}| $ & $|\mathcal{D}_{0.05} \cap \mathcal{R}_{0.05} \cap \mathcal{E}_{0.05}|$ & $N_g$   \\
      \midrule
