...
\caption{
Empirical CDF for observed data (green) vs. empirical CDF for counts simulated from the fitted mixture NB (pink) for
...
Each think pink curve is from one of the randomized distances; the
 the thicker pink curve represents pointwise averaging over 10 randomized distance matrices. Note horizontal scales
differ among the panels.  Cells in both conditions are pooled.}
\label{fig:cdf}
\end{figure}
