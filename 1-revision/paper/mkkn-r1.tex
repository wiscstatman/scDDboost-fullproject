...
of scenarios we might expect to see in practice.  \textcolor{blue}{Ten replicate data sets were simulated under each parameter setting.}
...
\subsection{\textcolor{blue}{Diagnostics}}
