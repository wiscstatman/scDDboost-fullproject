...
We propose distance-based clustering to convey subtype information (Section 2.2), and one may ask
...
permutatation study (Supplementary Material, Figure S15).  **difference** Table S?.
