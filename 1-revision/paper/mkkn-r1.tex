...
distribution is only mildly affected  (Supplementary Table~S4; Figure~S14). 
Even with evident model mis-specification, 
...
\caption{
Empirical CDF for observed data (green) vs. empirical CDF for expression levels simulated from the fitted NB mixture (pink) for
...
Each thik pink curve is from one of the randomized distances; the
