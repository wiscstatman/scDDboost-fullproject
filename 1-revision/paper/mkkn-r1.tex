...
which measures changes in a gene's marginal sampling distribution, 
...
of this rate is an empirical Bayesian posterior probability of differential distribution. 
...
Note the sampling model induced by splatter is distinct from the more descriptive model 
