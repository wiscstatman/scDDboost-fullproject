...
\textcolor{blue}{make the point that splatter is a different model than scDDboost}
...
\begin{table}[htbp]
  ...
  \end{center}
\end{table}
We also run \texttt{scDDboost} with \textt{sc3} on null case data sets used in Figure~\ref{nullperm} and simulation data. 
