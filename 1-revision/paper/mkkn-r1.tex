...
(Figure 1), just six of them fails the NB test, and only two genes against the NB assumption are uniquely called by \texttt{scDDboost}, further one of the two genes is cell-cycle related.
...
distribution is only mildy affected  (Supplementary Table S4; Figures **).  **Here's a good
