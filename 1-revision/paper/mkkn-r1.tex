...
%between the two cellular conditions in view.  \textcolor{red}{The goal is to score genes
...
\textcolor{red}{The beneficial sampling  properties are not limited to the 5\% FDR threshold, as indicated by
...
\caption{
\textcolor{red}{Empirical CDF for observed data (green) compared to expression levels simulated from the fitted NB mixture (pink) for
...
\subsubsection*{\textcolor{red}{Choice of distance function}}

\textcolor{red}{We propose distance-based clustering to convey subtype information (Section 2.2), and one may ask
