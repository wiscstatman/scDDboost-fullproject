...
The default distance tends to post fewer genes than  \texttt{SC3}, though what is found by the default
is mostly found by \texttt{SC3} (Supplementary Table~\ref{tab:dist}).
\begin{table}[htbp]
  \begin{center}
  %\topcaption{Table captions are better up top} % requires the topcapt package
  \begin{tabular}{@{} lccccr @{}} % Column formatting, @{} suppresses leading/trailing space
      ...
      GSE45719   & 0.94 & 75\% & 4851 & 7591 & 4805\\
      GSE64016 & 0.33 & 80\% & 3395& 665 & 529\\
      \bottomrule
  \end{tabular}
  \caption{Relation of findings from two different distance methods in two data sets (rows). cor denotes
correlation of the scDDboost local FDR probabilities, and $n_{DD}$ is the number found DD at 5\% FDR.
