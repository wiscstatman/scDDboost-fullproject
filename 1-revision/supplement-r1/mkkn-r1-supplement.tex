...
Also given $z$, $X_{g,c}$ is sampled through a negative binomial distribution 
that depends on the group $z_c$ and gene-level parameters, but not the sample labels $y$.
