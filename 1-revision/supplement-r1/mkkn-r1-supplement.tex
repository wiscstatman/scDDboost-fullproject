...
\begin{figure}[h!]
  ...
  \caption{Cumulative distribution functions for subtype specific fdr adjusted p values of goodness of fit for NB distribution at two data sets, different colors are correspond to different subtypes}
  \label{fig:nb}
\end{figure}

We found that the distribution functions are right skewed and only for a small proportions of genes that NB assumption may be inappropriate
Further,
