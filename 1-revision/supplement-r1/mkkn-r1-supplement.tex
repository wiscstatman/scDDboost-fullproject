...
\item Modeling
 \begin{itemize}
  \item 2.1 Data Structure, Sampling Model, and Parameters
    \begin{list}{}{}
    \item Illustrating {\em key issue}
...
\noindent
{\bf Likelihood ratio test:} Let $\sigma^k$ be the shape parameter from subtype $k$
...
We also check FDR on simulation, five datasets from simulation are used and we found that FDR is well controlled. \texttt{scDDboost} control FDR regardless of the input clustering methods.
\begin{figure}[h!]
