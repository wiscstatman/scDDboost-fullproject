...
\vspace{.2in}
\noindent
Version:  \today.  Additions over the previous version are indicated in \textcolor{red}{red}.
...
\item Modeling
 \begin{itemize}
  \item 2.1 Data Structure, Sampling Model, and Parameters
    \begin{list}{}{}
    \item \textcolor{red}{Illustrating key issue}
...
of moments, noting $d_0=E( 1/d_{i,j} )/var[ 1/d_{i,j} ]$ .  Next we estimate $a_0$ and $a_1$ by 
...
\includegraphics[scale = 0.7]{Figs/ARI.pdf}
 ...
 clusterings **relative to what?**  generated by randomizing distances.
