...
but using \texttt{SC3} distance in place of the default distance.
Let $p_o$ be the proportion of commonly identified genes among the top 1000 and $n_{DD}$ be the number of DD genes. 
The clustering methods have some effects on the final list of DD genes but many of the top level called out gene are commonly identified(Supplementary Table~\ref{tab:dist}).
