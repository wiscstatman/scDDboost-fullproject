...
\caption{Data set Fucci, random select 9 genes among genes having at least one positive transcripts, Green curve refers to empirical CDF of the gene transcripts, each light thin pink curve refers empirical CDF fitted on data simulated from our estimated mixture NB model. The dark thick pink curve represents the average estimation. Here we averaged estimations from 10 randomized clusterings.}
\label{fig:cdf}
\end{figure}
