...
(also called location and scale parameters,
\bf{de.facLoc} and \bf{de.facScale})
...
%\textcolor{blue}{**Xiuyu: I don't see what 
...
\begin{figure}[h!]
  ...
  Different parameters resulted in different degree of separation of subtypes. We have 4 different settings for hyper-parameters of simulation. 
  We choose 2 from the 10 replicates. The two rows are corresponding to 2 replicaes.  
