...
by swapping of the max element of $S_1$ with min element of $S_2$ as $S_1^*$ and $S_2^*$ and swapping of the max element of $S_1$ with the max element of $S_2$ as $S_1^{**}, S_2^{**}$ accordingly.
