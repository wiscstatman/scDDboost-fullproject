...
Supplementary Figure \ref{fig:nb} presents the cumulative distribution of goodness-of-fit test p-values under each subtype, and
...
Let $\mathcal{U}_{0.05}$ be the union genes identified by t-test, DESeq2, MAST and scDD as differential between
the two groups.
...
\begin{figure}[h!]
  ...
  \caption{Boxplot of FDR adjusted p-values by other methods, separated by non-constant shape genes uniquely identified
