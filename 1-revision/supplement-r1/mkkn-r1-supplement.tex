...
\begin{figure}[h!]
  \includegraphics[ width = 0.7\textwidth]{Figs/Roc_supp.pdf}
...
the two groups.
Table \ref{tab:cs} demonstrates that most identified by \texttt{scDDboost} are also confirmed by other tests. 
\begin{table}[htbp]
  \begin{center}
