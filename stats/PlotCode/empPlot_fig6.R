...
total_g = c(45686,65218,27723,47192,22443,23337,24057,38390,19974,19084,19097,23368)
nDD_mst = c(9437,4565,3449,8044,1783,2179,5609,1506,2714,7170,12725,0)
nDD_des = c(8620,4667,1541,7878,2561,4173,2062,541,1191,5951,11217,0)
nDD_sc = c(7259,2199,1724,9184,1154,1570,2468,1010,1091,7106,10598,0)
nDD_scb = c(9392,5023,434,11954,7740,3051,3324,3953,3631,5057,13221,0)
#total_g = rep(1,13)
