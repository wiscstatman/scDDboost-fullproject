...
```{r}
 # following Xiuyu's schematic (from polygon.r)
## but now I see a problem with Xiuyu's schematic...it suggests a necessary ordering of the
## units within blocks, which is not necessary; going back to original

library(MCMCpack)

set.seed(33)
K = 7
##get proportion p and q such that 
# p1 + p2 = q1 + q2, p3 + p4 + p5 = q3 + q4 + q5 and p6 + p7 = q6 + q7
...
```{r, fig.cap="Multinomial probability vectors for two conditions arranged according to a fixed partition", fig.height=4}
