...
$$L = \sum_{i, j} \text{log}(P(d_{i,j} | a_0, a_1, d_0)) = \text{log}(\Gamma(a_0 + a_1)) - \text{log}(\Gamma(a_0)) - \text{log}(\Gamma(a_1)) + a_1 \text{log}(d_0) + (a_1 - 1) \text{log}(d_{i,j}) - $$
...
plot(c(rep(c(a0,d0,a1),each = N)) ,c(est.a0,est.d0,est.a1), xlab = "true param", ylab = "estimate param")
points(a0,a0,col = "red", pch = 19, lwd = 2)
points(d0,d0,col = "red", lwd = 2)
points(a1,a1,col = "red", lwd = 2)
